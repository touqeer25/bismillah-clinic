...
(async()=>{
  ...
  w.repDiffSetTab('mm'); for(let i=0;i<300&&!d.querySelector('.rep-mm-card .rep-mm-draft');i++)await sleep(100);
  ok(d.querySelector('.rep-mm-card')&&d.querySelector('.rep-mm-draft'),'📖 tab renders with a draft (progressive load ok)');
